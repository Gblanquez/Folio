    ...
    transitions: [
      ...
      },
      {
        ...
        async enter(data) {
          ...
          await Promise.all([
            gsapWithCSS.from(mainWorkBg, {
              y: "-120%",
              duration: 1,
              delay: 0.1,
              ease: "expo.out"
            }),
            gsapWithCSS.from(textPageWork, {
              y: "120%",
              delay: 0.1,
              opacity: 0,
              duration: 1.2,
